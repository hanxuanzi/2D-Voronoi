...
class voronoicell_base {
	public:
		std::vector<Point<>>savepoint1, savepoint2;//¥Ê¥¢µ„
		...
		void draw_pov(double x, double y, double z,std::vector<Point<>>&edge1,std::vector<Point<>>&edge2);
...
// 		inline void draw_pov(double x, double y, double z,int i) {
// 			draw_pov(x, y, z,i);
// 		};
		...
		void output_vertices(int i, double x, double y, double z, VoroPProperties* VoroPProperties);//÷ÿ‘ÿ
		...
		void output_custom(const char* format, int i, double x, double y, double z, double r, VoroPProperties* VoroPProperties);//÷ÿ‘ÿ
